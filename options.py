...
class Options():
    ...
    def initialize(self):
        parser = self.parser
        parser.add_argument('--save_loc', default="D:/D/LNAF/3/Learning_Neural_Acoustic_Fields-master/results2_1", type=str)


       # parser.add_argument('--apt', default='office_4', choices=[ 'apartment_2', 'frl_apartment_2', '', 'office_4', 'room_2'], type=str)
        parser.add_argument('--apt', default='apartment_1',choices=['apartment_1'],type=str)

        parser.add_argument('--exp_name', default="{}")

        # dataset arguments
        parser.add_argument('--coor_base', default="D:/D/LNAF/3/Learning_Neural_Acoustic_Fields-master/metadata/replica", type=str)  # Location of the training index to coordinate mapping
        parser.add_argument('--spec_base', default="D:/D/LNAF/3/Learning_Neural_Acoustic_Fields-master/metadata/magnitudes", type=str)  # Location of the actual training spectrograms
        parser.add_argument('--mean_std_base', default="D:/D/LNAF/3/Learning_Neural_Acoustic_Fields-master/metadata/mean_std", type=str)  # Location of sound mean_std data
        parser.add_argument('--minmax_base', default="D:/D/LNAF/3/Learning_Neural_Acoustic_Fields-master/metadata/minmax", type=str)  # Location of room bbox data
        ...
        parser.add_argument('--split_loc', default="D:/D/LNAF/3/Learning_Neural_Acoustic_Fields-master/metadata/train_test_split/", type=str) # Where the train test split is stored
        ...
        parser.add_argument('--epochs', default=340, type=int) # Total epochs to train for
   ...
   #     self.opt.max_len = {"apartment_1": 101,"apartment_2": 86, "frl_apartment_2": 107, "frl_apartment_4": 103,
    #       "office_4": 78, "room_2": 84}
        self.opt.max_len = {"apartment_1": 101}
