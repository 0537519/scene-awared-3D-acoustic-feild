...
import pickle
import os
from model.networks_2 import kernel_residual_fc_embeds
from model.modules import embedding_module_log
import math
from options import Options

weight_path="D:/D/LNAF/2/Learning_Neural_Acoustic_Fields-master/weight_apartment_2"

def to_torch(input_arr):
    return input_arr[None]

def t(rank, other_args):
    pi = math.pi
    output_device = rank
